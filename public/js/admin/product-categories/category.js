...
//             success: function (response) {
//                 $("#categorytitleData").val(response.message.name);
//                 $("#categoryParent").val(response.message.parent__category);
...
//                 $.ajax({
//                     type: "get",
//                     url: "/admin/product-categories/status/" + id,
//                     success: function () {
