            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function ($item) {
                    ...
                    <div class="d-flex gap-1">
                        <button class="btn btn-sm btn-outline-warning editTourBatchBtn" data-id="' . $item->id . '">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger deleteTourBatchBtn" data-id="' . $item->id . '">
