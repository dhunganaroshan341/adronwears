            ...
            <div class="row mt-3 mb-3">
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="col-md-2 mt-4">
                        <button type="button" class="btn btn-outline-dark mt-1 addMoreBtn">Add
                            More</button>
                        <button type="button" class="btn btn-outline-danger mt-1 removeBtn" disabled>Remove</button>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        <div class="row moreSheduleDataFetch mt-2 mb-2">
                        ...
                        <div class="col-md-2 mt-4">
                            <button type="button" class="btn btn-outline-dark mt-1 addMoreBtn">Add More</button>
                            <button type="button" class="btn btn-outline-danger mt-1 removeBtn">Remove</button>
                        </div>
        </div>`;
