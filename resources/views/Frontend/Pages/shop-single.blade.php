                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <ul class="list-inline pb-3">
                                        <li class="list-inline-item">Available Size :
                                            <input type="hidden" name="product-size" id="product-size" value="S">
                                        </li>
                                        <li class="list-inline-item"><span
                                                class="btn disabled btn-success btn-size">S</span>
                                        </li>
                                        <li class="list-inline-item"><span
                                                class="btn disabled btn-success btn-size">M</span>
                                        </li>
                                        <li class="list-inline-item"><span
                                                class="btn disabled btn-success btn-size">L</span>
                                        </li>
                                        <li class="list-inline-item"><span
                                                class="btn  disabledbtn-success btn-size">XL</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-auto">
...
@endsection
@push('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('fashion-shop-template/assets/css/slick.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('fashion-shop-template/assets/css/slick-theme.css') }}">
